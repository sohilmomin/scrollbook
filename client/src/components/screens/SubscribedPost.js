            ...
            <div className="home">
                {
                    data.length !== 0 ?
                                ...
                                <div key={item._id} className="card home-card">
                                    <div className="header-post">
                                        <Link to={item.postedBy._id !== state._id ? "/profile/" + item.postedBy._id : "/profile"}>
                                            {item.postedBy.pic ?
                                                <img className="small-profile-pic" align="left" src={item.postedBy.pic} alt="P"></img>
                                                :
                                                <img className="small-profile-pic" align="left" src="https://res.cloudinary.com/sohil/image/upload/v1599484962/default_pic_boplg1.png" alt="P"></img>
                                            }
                                        </Link>
                                    ...
                                    <div className="card-image">
                                        <img className="item postImage" src={item.photo}
                                            alt="Post" />
                                    </div>
                        ...
                        :
                        <div className="not-subscribed">You haven't Subscribed yet anyone.</div>
                }
            </div>
        </>
    )
